...
func getToolInputSchema(name string) string {
	schemas := map[string]string{
		...
		"plan_create":           `{"type":"object","properties":{"title":{"type":"string","description":"Plan title"},"description":{"type":"string","description":"Plan description"},"phases":{"type":"integer","description":"Number of phases"}},"required":["title"]}`,
		...
		"agent_register_work":   `{"type":"object","properties":{"task":{"type":"string","description":"Task description"},"priority":{"type":"string","enum":["low","normal","high"]}},"required":["task"]}`,
